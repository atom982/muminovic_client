<template>
  <span class="vuestic-tag" :class="tagClass">
    {{ name }}
    <span class="vuestic-tag-button" v-if="removable" @click="remove">
...
// Colors //
  ...
  $theme-colors: ( "primary": $brand-primary, "secondary": $white, "success": $light-green, "info": $brand-info, "warning": $brand-warning, "danger": $brand-danger, "light": $light-gray2, "dark": $almost-black, "pale": $theme-pale);
  // Layout //
  $body-bg: $light-gray;
...
.vuestic-tag-primary {
  ...
  .vuestic-tag-button {
    color: #4ae387;
    &:hover {
      color: lighten(#4ae387, 15%);
    }
    &:focus, &:active {
      color: darken(#4ae387, 15%);
    }
  }
}
...
.vuestic-tag-danger {
  ...
  .vuestic-tag-button {
    color: #e34a4a;
    &:hover {
      color: lighten(#e34a4a, 15%);
    }
    &:focus, &:active {
      color: darken(#e34a4a, 15%);
    }
  }
}
...
.vuestic-tag-info {
  ...
  .vuestic-tag-button {
    color: #4ab2e3;
    &:hover {
      color: lighten(#4ab2e3, 15%);
    }
    &:focus, &:active {
      color: darken(#4ab2e3, 15%);
    }
  }
}
...
.vuestic-tag-dark {
  ...
  .vuestic-tag-button {
    color: #161616;
    &:hover {
      color: lighten(#161616, 35%);
    }
    &:focus, &:active {
      color: darken(#161616, 15%);
    }
  }
}
...
.vuestic-tag-warning {
  ...
  .vuestic-tag-button {
    color: #f7cc36;
    &:hover {
      color: lighten(#f7cc36, 15%);
    }
    &:focus, &:active {
      color: darken(#f7cc36, 15%);
    }
  }
}
...
.vuestic-tag-pale {
  ...
  .vuestic-tag-button {
    color: #d9d9d9;
    &:hover {
      color: lighten(#d9d9d9, 5%);
    }
    &:focus, &:active {
      color: darken(#d9d9d9, 15%);
    }
  }
}
