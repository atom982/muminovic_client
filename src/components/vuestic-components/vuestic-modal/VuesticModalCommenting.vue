<template>
  <div class="vuestic-modal">
    <transition name="modal" :duration="duration">
      <div v-show="showCommenting" class="modal-container">
                    ...
                    <div class="col-md-12">
                      <div class="col-md-12">
                        <div class="input-group">
                          <textarea type="text" v-model="komentar" required></textarea>
...
export default {
  ...
  methods: {
    ...
    open() {
      this.showCommenting = true;
      window.addEventListener("keyup", this.listenKeyUp);
      // console.log('open () {')
      // console.log('Unos komentara:'+this.sid)
      http
        .get(
          "uzorci/komentar/" +
            this.sid +
        ...
        .then(res => {
          ...
          this.komentar = res.data.komentar;
        });
    },
    close() {
      this.showCommenting = false;
