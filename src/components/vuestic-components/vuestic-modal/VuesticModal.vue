          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <slot name="footer">
                ...
                <button v-if="!okText.includes('!SHOW')" type="button" :class="okClass" @click="ok"> {{okText}}</button>
              </slot>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ok() {
        ...
        bus.$emit('sacuvajAnalite')
        this.$emit('ok')
        bus.$emit('yes', true);
        bus.$emit('yesRacun', true, this.transition)
      ...
      cancel() {
        this.$emit('cancel')
        bus.$emit('no', false);
        bus.$emit('viseNo', false);
        bus.$emit('viseKo', false);
        this.show = false
      },
      clickMask() {
        if (!this.force) {
