<template>
  <div class="vuestic-modal">
    <transition name="modal" :duration="duration">
      <div v-show="showBarcode" class="modal-container">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div v-if="sid.length > 9" class="col-sm-4">
                    <barcode id="barcode" v-bind:value="sid" :options="{ displayValue: true , width: 1.25, fontSize: 20, textPosition: 'bottom',}"></barcode>
                  </div>
                </div>
