...
export default {
  name: "vuestic-modal-drugo-stanje",
  props: {
    transition: {
      type: String,
      default: "modal"
  ...
  methods: {
    ok() {
      // console.log("DrugoStanjeOn - Potvrda");
      bus.$emit("DrugoStanjeOn");
    ...
    cancel() {
      // console.log("DrugoStanjeOn - Cancel");
      bus.$emit("DrugoStanjeOff");
      this.$emit("cancel");
