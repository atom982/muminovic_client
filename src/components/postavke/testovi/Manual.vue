    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-widget
          ...
          headerText="Definicija testova - Ručni testovi"
        >
          <form>
            <div class="row">
        ...
        <vuestic-widget v-if="ifTrenutnePostavke" headerText="Trenutne postavke - Ručni testovi">
        ...
        <vuestic-widget
          v-if="ifDodajAnalit"
          headerText="Trenutne postavke - Ručni testovi - Dodaj analit"
        >
          <div class="row">
            <div class="col-md-5">
              <div class="row">
        ...
        .then(res => {
          ...
          if (res.data.grupa != undefined) {
            ...
            if (this.sekcija === "NEMA PODATAKA") {
              this.grupe = [];
              this.grupe.push("NEMA PODATAKA"); // kad za sekciju izaberem nema podataka - grupe mi prebaci na ovo...
            }
          } else {
            this.grupe = [];
            this.grupe.push("NEMA PODATAKA");
