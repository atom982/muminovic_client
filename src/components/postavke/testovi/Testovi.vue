    ...
    <div class="row">
      <div class="col-md-12">
        <vuestic-alert v-if="infoDanger" type="warning" :withCloseBtn="true">
          <span class="badge badge-pill badge-warning">{{'PAŽNJA'}}</span>
          <span>{{poruka}}</span>
        </vuestic-alert>
        ...
        <vuestic-alert v-if="infoWarning" type="danger" :withCloseBtn="false">
          <span class="badge badge-pill badge-danger">{{'GREŠKA'}}</span>
          <span>{{poruka}}</span>
        </vuestic-alert>
        <vuestic-alert v-if="infoInfo" type="info" :withCloseBtn="false">
          <span>{{poruka}}</span>
        </vuestic-alert>
        <vuestic-widget
          v-if="ifdodajTest && $store.state.userId === 'admin@atom.ba'"
          headerText="Definicija testova - Laboratorijski testovi"
        >
          <form>
            <div class="row">
              ...
              <div class="col-md-6">
                <fieldset>
                  ...
                  <vuestic-simple-select
                    label="Analit sadrži druge analite"
                    v-model="multi"
                    name="multi"
                    :required="true"
                    title=" "
                    ref="multiSelect"
                    v-bind:options="multiOpts"
                  ></vuestic-simple-select>
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      <input
                  ...
                  <div class="form-group with-icon-left">
                    <div class="input-group">
                      ...
                      >
                      <i class="glyphicon glyphicon-pencil icon-left input-icon"></i>
                      <label class="control-label" for="input-icon-left">{{'Unesite cijenu testa'}}</label>
                      <i class="bar"></i>
                    </div>
                  </div>
                  <vuestic-simple-select
                  ...
                  ></vuestic-simple-select>
                  <button class="btn btn-primary" @click.prevent="dodajPostavku">
        ...
        <vuestic-widget
          ...
          headerText="Trenutne postavke - Laboratorijski testovi"
        >
        ...
        <vuestic-widget
          v-if="ifDodajAnalit"
          headerText="Trenutne postavke - Laboratorijski testovi - Dodaj analit"
        >
          <div class="row">
            <div class="col-md-5">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div style="text-align:center;" class="testoviDiv">
                    <h5>Naziv testa:<span style="color: #e34a4a;"> {{analit}}</span></h5>
                ...
                <table v-if="tabelaUslov2" class="table table-striped first-td-padding">
                  ...
                  <tbody>
                    <tr v-for="element in analiti">
                      ...
                      <td style="width:130px; height:70%" v-if="tmpID != element.naziv">{{element.jedinica}}</td>
