  ...
  export default {
      ...
      hrSteps() {
        return [{
          ...
          },
          {
            ...
            isValid: () => {
              return (this.validateDate(this.datum_uzimanja) && this.validateTime(this.vrijeme_uzimanja) && this.isFormFieldValid('datum_uzimanja')  && this.isFormFieldValid('vrijeme_uzimanja') && this.isFormFieldValid('doktor') )
            }
          },
          {
                ...
                http.post('uzorci/savep', {
                  ...
                  .then(res => {
                    ...
                    res.data.data.forEach(element => {
                      this.specialTest = klasificiraj(element,this.jmbg,this.ime.toUpperCase().trim(),this.prezime.toUpperCase().trim(),this.spol,
                      this.location,this.datum_uzimanja,this.doctor,this.vrijeme_uzimanja,this.sekcija,this.drstanje,this.menstc,this.anticoag,
                      this.menopauza,this.$store.state.userId,this.$store.state.token,this.jmbgObj,this.$store.state.site,this.sajtSifra,
                      this.prioritet,this.komentar)
                      i+=1
                      ...
                      this.pid = element.pid
                        ...
                        specialTest:this.specialTest
                                ...
                                if(res.data.success){
                                  ...
                                  http.get('uzorci/barcode/' + res.data.data.sid + '?token=' + this.$store.state.token + '&site=' + this.$store.state.site, {
                                  }).then(res => {          
                                          printEPL( res.data.ime,  res.data.sid, res.data.pacijentRBr, res.data.godiste,res.data.datum,res.data.link,res.data.code,this.$store.state.site)
                                          })  
                                  }else{
                              ...
                              if(res.data.data.specialTest[0].test === "OGTT-60"){
                                ...
                                // console.log(res.data.data.specialTest[0].json)//60
                                 http.post('uzorci/save',res.data.data.specialTest[0].json).then(res => {
                                  ...
                                  http.get('uzorci/barcode/' + res.data.data.sid + '?token=' + this.$store.state.token + '&site=' + this.$store.state.site, {
                                    ...
                                    if(this.OGTT120.test ==="OGTT-120"){
                                      ...
                                      // console.log(this.OGTT120)
                                      http.post('uzorci/save',this.OGTT120.json).then(res => {
                                        if(res.data.success){
                                      http.get('uzorci/barcode/' + res.data.data.sid + '?token=' + this.$store.state.token + '&site=' + this.$store.state.site, {
                                      }).then(res => {          
                                          printEPL( res.data.ime,  res.data.sid, res.data.pacijentRBr, res.data.godiste,res.data.datum,res.data.link,res.data.code,this.$store.state.site)
                              ...
                              if(res.data.data.specialTest[0].test === "Prolaktin P2"){//----Prolaktin pool
    ...
    watch: {
      ...
      lokacija: function() {
        ...
        http.post('/uzorci/sekcije/listp', { // Dohvati testove, na promjenu tipa
            token: this.$store.state.token,
            site: this.$store.state.site
          })
          .then(res => {
